...
public class CalculatorController {
    ...
    public ResponseEntity sum(@RequestBody InputRequest inputRequest) {
        ...
        log.info("successful division--->",kv("EventCode","divisionSuccessful"),kv("details",mapper.toString()));        return new ResponseEntity(addition, HttpStatus.OK);
    }
    ...
    public ResponseEntity sub(@RequestBody InputRequest inputRequest) {
        ...
        mapper.put("number2",inputRequest.getNumber2());
        mapper.put("result",inputRequest.getResult());
        log.info("successful division--->",kv("EventCode","divisionSuccessful"),kv("details",mapper.toString()));        return new ResponseEntity(subtraction, HttpStatus.OK);
    }
